...
import './PageRegistrationPendingApproval.css';

const PageRegistrationPendingApproval = ( props ) => {
  return (
    <Page title="Register Pending" description="Registration is pending approval">
