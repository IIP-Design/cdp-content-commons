...
import makeSelectVideoSupportFiles from './selectors';
...
const mapStateToProps = ( state, props ) => createStructuredSelector( {
  videosupportfiles: makeSelectVideoSupportFiles()
} );

export default connect( mapStateToProps, actions )( VideoSupportFiles );
