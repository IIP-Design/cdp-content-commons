...
import makeSelectVideoProjectFiles from './selectors';
...
const mapStateToProps = ( state, props ) => createStructuredSelector( {
  videoprojectfiles: makeSelectVideoProjectFiles()
} );

export default connect( mapStateToProps, actions )( VideoProjectFiles );
